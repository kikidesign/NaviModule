...
- (UITableViewCell *)tableViewCellForViewMode
{
    ...
    [_viewModeSeg setFrame:CGRectMake(CGRectGetWidth(_optionTableView.frame) - 160, (kTableViewCellHeight - 30)/2.0, 150, 30)];
...
- (UITableViewCell *)tableViewCellForNightType
{
    ...
    _nightTypeSeg.frame = CGRectMake(CGRectGetWidth(_optionTableView.frame) - 160, (kTableViewCellHeight - 30)/2.0, 150, 30);
