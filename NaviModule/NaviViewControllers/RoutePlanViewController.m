...
- (void)initNaviPoints
{
    _startPoint = [AMapNaviPoint locationWithLatitude:121.469422 longitude:31.221694];
    _endPoint   = [AMapNaviPoint locationWithLatitude:121.515626 longitude:31.287070];
}
